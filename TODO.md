...
- [ ] Расширить официальный queue-check поверх `scripts/moex_blue_chip_queue.py` от одной корзины `MOEXBC` к более широкой очереди ликвидных MOEX-эмитентов, чтобы следующая волна покрытия выбиралась не вручную.
