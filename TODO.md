...
- [x] Открытые issues: на 2026-04-06 публичная страница `https://github.com/denis-gordeev/My-RU-Coverage/issues` показывает `No results` для `is:issue state:open`.
- [x] Открытые PR: на 2026-04-06 публичная страница `https://github.com/denis-gordeev/My-RU-Coverage/pulls` показывает `0 Open`.
