...
- [ ] Сформировать следующую очередь ликвидных MOEX-тикеров после закрытия блока `NVTK`/`NLMK` и подтвердить, какие эмитенты ещё не покрыты отдельными RU-карточками.
