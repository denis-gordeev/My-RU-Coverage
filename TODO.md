...
- [ ] Продолжить перевод `themes/` к преобладающе российскому набору уже после выноса legacy в архив: следующими кандидатами на новые RU-темы идут `строительство`, `логистика`, `онлайн-реклама` и другие повторяющиеся русскоязычные `wikilinks`.
