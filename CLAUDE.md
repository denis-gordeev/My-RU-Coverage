...
## Назначение
Репозиторий ведётся как база заметок покрытия по компаниям с фокусом на российский рынок и русскоязычный контекст. Legacy-тайваньский корпус сохранён в `Pilot_Reports_LEGACY/` как архив и не влияет на текущий рабочий процесс.
