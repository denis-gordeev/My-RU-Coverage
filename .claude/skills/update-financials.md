...
**Весь контент обогащения (Описание деятельности, Положение в цепочке поставок, Ключевые клиенты и поставщики) сохраняется — заменяются только финансовые данные.**
