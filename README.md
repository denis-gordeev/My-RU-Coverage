...
- `TODO.md` — живой журнал раундов автоматизации, сделанных фиксов и следующей очереди.
...
- Единицы: `.ME` -> `млн руб.`
- Российские карточки не должны содержать устаревшие темы и китайские викалинки.
