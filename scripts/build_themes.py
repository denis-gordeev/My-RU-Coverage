...
THEME_DEFINITIONS = {
    ...
    "продуктовая розница": {
        ...
        "desc": "Сети магазинов повседневного спроса, логистика ТНП и многоканальные форматы продаж",
    ...
    "интернет-торговля": {
        ...
        "desc": "Российские сервисы интернет-заказа, цифровые витрины, инструменты для продавцов и платёжно-логистическая инфраструктура вокруг интернет-торговли",
