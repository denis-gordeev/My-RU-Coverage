...
THEME_DEFINITIONS = {
    ...
    "банки": {
        ...
        "desc": "Крупнейшие банки и финансовые платформы российского рынка: кредитование, платежи, транзакционное направление и сопутствующие сервисы платформы",
        "related": ["финансовые технологии", "совокупности сервисов"],
    },
    "финансовые технологии": {
        ...
        "related": ["банки", "совокупности сервисов", "телеком"],
    },
    "нефтегаз": {
    ...
    "телеком": {
        ...
        "desc": "Мобильная связь, фиксированный ШПД, корпоративные ИКТ-сервисы и цифровые совокупности сервисов",
        "related": ["финансовые технологии", "совокупности сервисов"],
    },
    "продуктовая розница": {
        ...
        "related": ["доставка", "интернет-торговля", "совокупности сервисов"],
    },
    "доставка": {
    ...
    "совокупности сервисов": {
        "name": "Платформы совокупности сервисов",
    ...
    "интернет-платформы": {
        ...
        "related": ["совокупности сервисов", "торговые площадки", "финансовые технологии"],
    },
    "торговые площадки": {
        ...
        "related": ["интернет-платформы", "совокупности сервисов", "финансовые технологии"],
    },
    "биржевая инфраструктура": {
    ...
    "интернет-реклама": {
        ...
        "related": ["интернет-платформы", "интернет-торговля", "совокупности сервисов"],
    },
    "недвижимость": {
    ...
    "холдинг": {
        ...
        "related": ["совокупности сервисов", "финансовый рынок", "телеком"],
    },
    "программное обеспечение": {
...
SECTOR_THEME_MAP = {
    ...
    "Интернет-информационные сервисы": ["интернет-платформы", "интернет-реклама", "совокупности сервисов"],
