...
THEME_DEFINITIONS = {
    ...
    "банки": {
        ...
        "desc": "Крупнейшие банки и финансовые платформы российского рынка: кредитование, платежи, транзакционное направление и сопутствующие услуги платформы",
        "related": ["финансовые технологии", "совокупности услуг"],
    },
    "финансовые технологии": {
        "name": "Финансовые технологии и платёжные услуги",
        "desc": "Цифровые платежи, банковские приложения, кредитные услуги и смежная инфраструктура",
        "related": ["банки", "совокупности услуг", "телекоммуникации"],
    },
    "нефтегаз": {
    ...
    "телекоммуникации": {
        "name": "Телекоммуникации и цифровая инфраструктура",
        "desc": "Мобильная связь, фиксированный ШПД, корпоративные информационно-коммуникационные технологии и цифровые совокупности услуг",
        "related": ["финансовые технологии", "совокупности услуг"],
    },
    "продуктовая розница": {
        ...
        "related": ["доставка", "интернет-торговля", "совокупности услуг"],
    },
    "доставка": {
        "name": "Доставка и услуги «последней мили»",
        "desc": "Курьерские перевозки, доставка до дома и модели обслуживания, ускоряющие оборот интернет-платформ и розницы",
        "related": ["интернет-торговля", "торговые площадки", "продуктовая розница"],
    },
    "интернет-торговля": {
        "name": "Интернет-торговля",
        "desc": "Российские услуги интернет-заказа, цифровые витрины, инструменты для продавцов и платёжно-складская инфраструктура вокруг интернет-торговли",
    ...
    "совокупности услуг": {
        "name": "Платформы совокупности услуг",
        "desc": "Компании, извлекающие доход из основного направления через финансовые технологии, подписки, ИТ-услуги и смежные цифровые продукты",
        "related": ["финансовые технологии", "телекоммуникации", "банки"],
    },
    "интернет-платформы": {
        "name": "Интернет-платформы и цифровые услуги",
        "desc": "Российские платформы с масштабным потоком посетителей, рекламой, подписками, обслуживания и облачными вертикалями",
        "related": ["совокупности услуг", "торговые площадки", "финансовые технологии"],
    },
    "торговые площадки": {
        "name": "Торговые площадки и интернет-торговля",
        "desc": "Площадки, связывающие продавцов и покупателей через ассортимент, рекламу, транспортно-складское обеспечение и платёжные услуги",
        "related": ["интернет-платформы", "совокупности услуг", "финансовые технологии"],
    },
    "биржевая инфраструктура": {
        "name": "Биржевая инфраструктура",
        "desc": "Площадки, взаимозачёт обязательств, депозитарные и послеторговые услуги, обеспечивающие функционирование локального рынка капитала",
    ...
    "интернет-реклама": {
        ...
        "desc": "Цифровая реклама, автоматизированная покупка рекламы, поисковая и контекстная реклама в российском интернет-пространстве",
        "related": ["интернет-платформы", "интернет-торговля", "совокупности услуг"],
    },
    "недвижимость": {
    ...
    "импортозамещение": {
        ...
        "related": ["информационная безопасность", "банки", "электроэнергетика"],
    },
    "информационная безопасность": {
        ...
        "related": ["импортозамещение", "телекоммуникации", "банки"],
    },
    "автомобилестроение": {
    ...
    "АЗС": {
        ...
        "desc": "Автозаправочные станции, розничный сбыт моторного топлива и сопутствующие услуги на трассах",
    ...
    "холдинг": {
        ...
        "related": ["совокупности услуг", "финансовый рынок", "телекоммуникации"],
    },
    "программное обеспечение": {
        ...
        "related": ["импортозамещение", "информационная безопасность", "интернет-платформы"],
    },
}
