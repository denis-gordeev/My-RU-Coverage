...
THEME_DEFINITIONS = {
    ...
    "продуктовая розница": {
        ...
        "related": ["доставка", "электронная коммерция", "экосистемы"],
    },
    "доставка": {
        ...
        "related": ["электронная коммерция", "торговые площадки", "продуктовая розница"],
    },
    "электронная коммерция": {
    ...
    "торговые площадки": {
        "name": "Торговые площадки и электронная коммерция",
    ...
    "онлайн-реклама": {
        "name": "Онлайн-реклама и цифровое продвижение",
    ...
    "недвижимость": {
        ...
        "desc": "Рынок жилой и коммерческой недвижимости, онлайн-платформы объявлений, застройка и управление активами",
...
SECTOR_THEME_MAP = {
    ...
    "Интернет-розница": ["торговые площадки", "электронная коммерция", "доставка"],
