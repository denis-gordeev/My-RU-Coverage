...
THEME_DEFINITIONS = {
    ...
    "продуктовый ритейл": {
        ...
        "desc": "Сети магазинов повседневного спроса, логистика ТНП и омниканальные форматы продаж",
        "related": ["доставка", "электронная коммерция", "продуктовый онлайн-ритейл", "экосистемы"],
    },
    "доставка": {
        "name": "Доставка и сервисы «последней мили»",
        "desc": "Курьерская логистика, доставка до дома и сервисные модели, ускоряющие оборот интернет-платформ и розницы",
        "related": ["электронная коммерция", "маркетплейсы", "продуктовый ритейл"],
    },
    "электронная коммерция": {
        "name": "Электронная коммерция",
        "desc": "Российские сервисы онлайн-заказа, цифровые витрины, инструменты для продавцов и платёжно-логистическая инфраструктура вокруг электронной коммерции",
    ...
    "маркетплейсы": {
        "name": "Маркетплейсы и электронная коммерция",
    ...
    "биржевая инфраструктура": {
        ...
        "desc": "Площадки, клиринг, депозитарные и послеторговые сервисы, обеспечивающие функционирование локального рынка капитала",
    ...
    "онлайн-реклама": {
        "name": "Онлайн-реклама и цифровой маркетинг",
...
SECTOR_THEME_MAP = {
    ...
    "Материалы": ["золото"],
    "Финансовые услуги": ["банки", "финтех", "биржевая инфраструктура", "финансовый рынок"],
    "Телекоммуникации": ["телеком"],
    "Связь": ["телеком", "конгломерат"],
    "Интернет-контент и информация": ["интернет-платформы", "онлайн-реклама", "экосистемы"],
    "Интернет-розница": ["маркетплейсы", "электронная коммерция", "доставка"],
    "Продуктовые магазины": ["продуктовый ритейл"],
    "Потребительские товары повседневного спроса": ["продуктовый ритейл", "доставка"],
