...
THEME_DEFINITIONS = {
    ...
    "экосистемы": {
        ...
        "desc": "Компании, монетизирующие базовый бизнес через финансовые технологии, подписки, ИТ-сервисы и смежные цифровые продукты",
...
SECTOR_THEME_MAP = {
    ...
    "Интернет-контент и информация": ["интернет-платформы", "интернет-реклама", "экосистемы"],
