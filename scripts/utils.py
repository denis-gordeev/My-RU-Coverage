...
WIKILINK_ALIASES = {
    ...
    "корпоративный клиент": "клиент из числа предприятий",
    "корпоративный заказчик": "заказчик из числа предприятий",
...
LOCAL_COMPANY_TICKERS = {
    ...
    "AQUA", "BELU",
    "VK Облако", "Касперский", "Ядро", "ДейтаПро", "Вайлдберриз",
