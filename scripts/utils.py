...
TICKER_SOURCE_OVERRIDES = {
    ...
    "YDEX": {
        ...
        "sector": "Связь",
        "industry": "Интернет-информационные сервисы",
...
SECTOR_TRANSLATION = {
    ...
    "Internet Content & Information": "Интернет-информационные сервисы",
...
WIKILINK_ALIASES = {
    ...
    "лидер": "крупнейший",
    "дистрибутив": "сборка",
    "Интернет-контент и информация": "Интернет-информационные сервисы",
    "сегмент": "сектор",
