...
АЛИАСЫ_ВИКИЛИНКОВ = {
    ...
    "CSPC Pharmaceutical": "CSPC Фарма",
    "Red Hat": "Ред Хэт",
    "SUSE": "ЗУСЕ",
    "Ubuntu": "Убунту",
    "Windows": "Виндовс",
...
ТЕХНОЛОГИЧЕСКИЕ_ТЕРМИНЫ = {
    ...
    "Ред Хэт", "Ред Хэт Энтерпрайз Линукс", "ЗУСЕ", "Убунту", "Виндовс", "СолидВоркс",
}
...
ТИКЕРЫ_РОССИЙСКИХ_КОМПАНИЙ = {
    ...
    "Сан Фарма", "Доктор Реддис", "CSPC Фарма",
    "Ред Хэт", "ЗУСЕ", "Убунту", "Виндовс",
    "СолидВоркс", "Бьессе", "Хомаг", "Итон", "АВС",
}
