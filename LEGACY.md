...
- Исторический корпус не редактируется и не обслуживается.
- При необходимости перенести историческую карточку в российский контур — создайте новый файл через `python scripts/add_ticker.py` и напишите описание на русском.
